                  ...
                  <div class="card mb-5">
                    <div class="card-header bg-danger pt-3">
                        <div class="text-center">
                            <p class="card-title text-white">Declined Orders
                        </div>
                    </div>
                    <div class="card-body">
                      <table id="productTable" class="table table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                          ...
                          $query = "SELECT 
                                ...
                                WHERE tc.status_id = 5 AND td.address_default = 1
                          ...
                          <td><?php echo $account_id;?></td>
                            ...
                            <td>
                                <?php 
                                    if($status_id == 5){
                                        echo "<span class='badge text-danger fw-bold'>$status_name</span>";
                                    }
                                ?>
                            </td>
                            <td>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                  <form method="post">
                                    ...
                                    WHERE tc.user_id = ? AND tc.status_id = 5 AND o.order_id = ?";
