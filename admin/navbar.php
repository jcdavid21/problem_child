  ...
  <div class="navbar-menu-wrapper d-flex align-items-top">
    <ul class="navbar-nav">
      <li class="nav-item fw-semibold d-none d-lg-block ms-0">
        ...
        <h3 class="welcome-sub-text">View the sales of the month/year</h3>
      </li>
    </ul>
...
<script>
    ...
    if(hours >= 0 && hours < 12){
        welcome_text.innerHTML = `Good Morning, <span class="text-black fw-bold" id="full_name">Admin</span>`;
    }else if(hours >= 12 && hours < 16){
        welcome_text.innerHTML = `Good Afternoon, <span class="text-black fw-bold" id="full_name">Admin</span>`;
    }else{
        welcome_text.innerHTML = `Good Evening, <span class="text-black fw-bold" id="full_name">Admin</span>`;
    }
</script>  
</body>
</html>