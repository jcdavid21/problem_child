        ...
        <?php require_once("./sidebar.php"); ?>
            ...
            <h4 class="card-title">Deactivated Users</h4>
                ...
                <table id="productTable" class="table table-striped nowrap" style="width:100%">
                            ...
                            <tbody>
                            <?php
                                $query = "SELECT user_id, CONCAT(first_name, ' ', last_name) as full_name, email, gender, contact_no, date_of_birth, picture_path, registered_at, isAdmin FROM users WHERE status_id = 0 ORDER BY registered_at DESC";
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success deactivateResBtn" id="<?php echo $data["user_id"] ?>" >
                                    <i class="fa-solid fa-shuffle"  style="color: #fcfcfc;"></i>
                                    </button>
                                </td>
                            </tr>
                            <?php
