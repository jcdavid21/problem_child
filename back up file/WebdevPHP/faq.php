...
<div class="text">
        ...
        <p>At Problem Child, we make shopping for street wear clothing a breeze. To place an order, simply select your desired items and add them to your cart. From there, you can proceed to checkout and enter your shipping and payment information. Once your order is confirmed, we will begin processing it immediately. </p>
    </div>

    <div class="text1">
        <h3>Is it possible to request custom orders or make alterations to the available products?</h3>
