...
<body>
    ...
    <div class="gallery">
        <div class="gallery-item">
            <a href="addtocart1.php"><img class="image" src="picture/all/pic21.png" alt="Image 11"></a>
            <p>Blushing Breeze</p>
            <p>₱ 500.00</p>
        </div>
        <div class="gallery-item">
            <a href="addtocart2.php"><img class="image" src="picture/all/pic22.png" alt="Image12"></a>
            <p>Whiskered Gray</p>
            <p>₱500.00</p>
        </div>
        <div class="gallery-item">
            <a href="addtocart3.php"><img class="image" src="picture/all/pic23.png" alt="Image 13"></a>
            <p>Hooded Grayscale</p>
            <p>₱500.00</p>
        </div>
        <div class="gallery-item">
            <a href="addtocart4.php"><img class="image" src="picture/all/pic24.png" alt="Image 14"></a>
            <p>Happy Brown</p>
            <p>₱550.00</p>
        </div>
        <div class="gallery-item">
            <a href="addtocart5.php"><img class="image" src="picture/all/pic24.png" alt="Image 15"></a>
            <p>Happy Brown</p>
            <p>₱550.00</p>
        </div>
