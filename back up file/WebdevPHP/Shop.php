...
<body>
    ...
    <div class="gallery">
        <div class="gallery-item">
            <p>ALL PRODUCTS</p> 
            <a href="home.php"><img src="picture/icon/gallery.png" alt="Image 1"></a>
        </div>
        <div class="gallery-item">
            <p style="margin-left: 190px;">T-SHIRT</p> 
            <a href="tshirt.php"><img src="picture/icon/gallery1.png" alt="Image 2"></a>
        </div>
        <div class="gallery-item">
            <p style="margin-left: 190px;">HOODIES</p> 
            <a href="hoodies.php"><img src="picture/icon/gallery2.png" alt="Image 3"></a>
        </div>
        <div class="gallery-item">
            <p style="margin-left: 190px;">BOTTOMS</p> 
            <a href="bottoms.php"><img src="picture/icon/gallery3.png" alt="Image 4"></a>
        </div>
        <div class="gallery-item">
            <p style="margin-left: 130px;">ACCESSORIES</p> 
           <a href="accessories.php"> <img src="picture/icon/gallery4.png" alt="Image 5"></a>
        </div>
        <div class="gallery-item">
            <p style="margin-left: 190px;">HEADWEAR</p> 
            <a href="headwear.php"><img src="picture/icon/gallery5.png" alt="Image 6"></a>
        </div>
    </div>
