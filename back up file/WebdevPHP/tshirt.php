...
<body>
    ...
    <div class="gallery">
        ...
        <div class="gallery-item">
            <a href="addtocart9.php"><img class="image" src="picture/all/pic7.png" alt="Image 9"></a>
            <p>Misty Figure</p>
            <p>₱350.00</p>
        </div>
        <div class="gallery-item">
            <a href="addtocart10.html"><img class="image" src="picture/all/pic7.png" alt="Image 10"></a>
            <p>Misty Figure</p>
            <p>₱350.00</p>
        </div>
    ...
    <footer>
        <div class="footer-content">
          ...
          <div class="logo2">
            <a href="home.html"><img  src="picture/icon/logo1.png" alt=""></a>
          </div>
