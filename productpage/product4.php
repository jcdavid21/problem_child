...
<body>
    ...
    <div class="main_container">
        <form id="addToCartForm" action="process_cart4.php" method="post">
                    ...
                    <div class="details_container">
                        <div class="details">
                            ...
                            <div class="image_container1">
                                <img class="image" src="../images/zoom/crop9.png" alt="">
                                <img class="image" src="../images/zoom/crop10.png" alt="">
                                <img class="image" src="../images/zoom/crop11.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        image.addEventListener('mouseout', () => {
            mainImage.src = '../images/all/pic4.png';
            mainImage.style.width = '500px';
            mainImage.style.height = '500px';
        });
        });
