...
<body>
                    ...
                    <div class="details_container">
                        <div class="details">
                            ...
                            <div class="image_container1">
                                <img class="image" src="../images/zoom/crop12.png" alt="">
                                <img class="image" src="../images/zoom/crop13.jpg" alt="">
                                <img class="image" src="../images/zoom/crop14.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        image.addEventListener('mouseout', () => {
            mainImage.src = '../images/all/pic5.png';
            mainImage.style.width = '500px';
            mainImage.style.height = '500px';
        });
        });
