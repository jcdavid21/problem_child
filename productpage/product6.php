...
<body>
    ...
    <div class="main_container">
        <form id="addToCartForm" action="process_cart2.php" method="post">
                    ...
                    <div class="details_container">
                        <div class="details">
                            ...
                            <div class="image_container1">
                                <img class="image" src="../images/zoom/crop15.png" alt="">
                                <img class="image" src="../images/zoom/crop16.jpg" alt="">
                                <img class="image" src="../images/zoom/crop17.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        image.addEventListener('mouseout', () => {
            mainImage.src = '../images/all/pic6.png';
            mainImage.style.width = '500px';
            mainImage.style.height = '500px';
        });
        });
