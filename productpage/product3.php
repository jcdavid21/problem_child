...
<body>
    ...
    <div class="main_container">
        <form id="addToCartForm" action="process_cart3.php" method="post">
                    ...
                    <div class="details_container">
                        <div class="details">
                            ...
                            <div class="image_container1">
                                <img class="image" src="../images/zoom/crop6.png" alt="">
                                <img class="image" src="../images/zoom/crop7.jpg" alt="">
                                <img class="image" src="../images/zoom/crop8.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        image.addEventListener('mouseout', () => {
            mainImage.src = '../images/all/pic3.png';
            mainImage.style.width = '500px';
            mainImage.style.height = '500px';
        });
        });
