...
<body>
    ...
    <div class="main_container">
        <form id="addToCartForm" action="process_cart5.php" method="post">
                    ...
                    <div class="details_container">
                        <div class="details">
                            ...
                            <div class="image_container1">
                                <img class="image" src="../images/zoom/crop1.png" alt="">
                                <img class="image" src="../images/zoom/crop2.jpg" alt="">
                                <img class="image" src="../images/zoom/crop3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper testimonials-slider js-testimonials-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide testimonials-item">
                            <div class="info">
                                <img src="../images/icon/profile.png" alt="profile1">
                                <div class="text-box">
                                    <h3 class="name">Marc Jeff</h3>
                                </div>
                            </div>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus pariatur itaque commodi in harum ratione ullam blanditiis odio fugit repellendus.</p>
                            <div class="rating">
