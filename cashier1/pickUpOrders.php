            ...
            <div class="card mb-5">
                    <div class="card-header bg-secondary pt-3">
                        <div class="text-center">
                            <p class="card-title text-light">Reserved Pending Orders
                        </div>
                    </div>
                    <div class="card-body">
                      <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                          ...
                          $query = "SELECT ta.account_id, 
                                    ...
                                    WHERE tc.status_id = 6 AND tc.order_type_id = 2
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                  <form method="post">
                                    ...
                                    WHERE tc.status_id = 6 AND ot.order_type_id = 2 AND tc.account_id = ?
                                    GROUP BY tc.item_id;";
                  ...
                  <div class="card mb-5">
                    <div class="card-header bg-secondary pt-3">
                        <div class="text-center">
                            <p class="card-title text-light">Reserved Accept Orders
                        </div>
                    </div>
                    <div class="card-body">
                      <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                          ...
                          $query = "SELECT ta.account_id, 
                                    ...
                                    INNER JOIN tbl_account_details ta ON tc.account_id = ta.account_id
                                    INNER JOIN tbl_status tr ON tc.status_id = tr.status_id
                                    WHERE tc.status_id = 4 AND tc.order_type_id = 2
                                    GROUP BY ta.account_id";
                          $stmt = $conn->prepare($query);
                          $stmt->execute();
                          $result = $stmt->get_result();
                          ...
                          <tr>
                            ...
                            <td>
                              <button type="button" class="btn btn-primary" data-bs-toggle="modal" 
                              data-bs-target="#residenceAccountDetails<?php echo $account_id.$status_id; ?>" data-bs-whatever="@getbootstrap">
                                <i class="fa-solid fa-eye" style="color: #fcfcfc;"></i>
                              </button>
                            </td>
                          </tr>
                          ...
                          <!-- Modal for displaying order details -->
                          <div class="modal fade" id="residenceAccountDetails<?php echo $account_id.$status_id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Order Details for <?php echo $full_name; ?></h5>
                                ...
                                <div class="modal-body row">
                                  <form method="post">
                                    ...
                                    LEFT JOIN tbl_account_details td ON td.account_id = tc.account_id
                                    LEFT JOIN tbl_status tr ON tc.status_id = tr.status_id
                                    WHERE tc.status_id = 4 AND ot.order_type_id = 2 AND tc.account_id = ?
                                    GROUP BY tc.item_id;";
                                    $stmt_orders = $conn->prepare($query_orders);
                                    $stmt_orders->bind_param("i", $account_id);
                                    $stmt_orders->execute();
