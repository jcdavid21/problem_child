          ...
          <div class="content-wrapper">
            ...
            <!-- Page indicator -->
                      ...
                      <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                          ...
                          $query = "SELECT ta.account_id, 
                                    ...
                                    WHERE tc.status_id = 3 AND tc.order_type_id = 1
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              data-bs-target="#residenceAccountDetails<?php echo $account_id; ?>" data-bs-whatever="@getbootstrap">
                          ...
                          <div class="modal fade" id="residenceAccountDetails<?php echo $account_id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body row">
                                  <form method="post">
                                    ...
                                    WHERE tc.status_id = 3 AND ot.order_type_id = 1 AND tc.account_id = ?
                                    GROUP BY tc.item_id;";
                                    $stmt_orders = $conn->prepare($query_orders);
                                    $stmt_orders->bind_param("i", $account_id);
                                    $stmt_orders->execute();
                                    ...
                                    <div class="mb-3 pb-5 border-bottom border-danger">
                                      <label class="col-form-label">Total</label>
                                      <input type="text" class="form-control" value="₱<?php echo number_format($total, 2); ?>" disabled>
                                    </div>
                                    <div class="mb-3 row justify-content-end">
                                      <button type="button" class="btn btn-danger delete-js col-md-4" id="<?php echo $order_data["item_id"] ?>" >
                                        Cancel Order
                                      </button>
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success updateBtn" data-status-id="<?php echo $status_id ?>" >
                  ...
                  <div class="card mb-5">
                    <div class="card-header bg-secondary pt-3">
                        <div class="text-center">
                            <p class="card-title text-light">Pick Up Accept Orders
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                          ...
                          <tbody>
                            ...
                            $accountQuery = "SELECT ta.account_id, 
                                                    CONCAT(ta.first_name, ' ', ta.middle_name, ' ', ta.last_name) as customer_name, 
                                                    ta.address as customer_address, 
                                                    tr.status_name as account_status, 
                                                    tr.status_id as account_status_id,
                                                    ta.contact as customer_contact
                                            FROM tbl_cart tc 
                                            INNER JOIN tbl_account_details ta ON tc.account_id = ta.account_id
                                            INNER JOIN tbl_status tr ON tc.status_id = tr.status_id
                                            WHERE tc.status_id = 4 AND tc.order_type_id = 1
                                            GROUP BY ta.account_id";
                            $accountStmt = $conn->prepare($accountQuery);
                            $accountStmt->execute();
                            $accountResults = $accountStmt->get_result();

                            while ($accountRow = $accountResults->fetch_assoc()) {
                              $customerId = $accountRow["account_id"];
                              $customerName = $accountRow["customer_name"];
                              $customerAddress = $accountRow["customer_address"];
                              $accountStatus = $accountRow["account_status"];
                              $customerContact = $accountRow["customer_contact"];
                              $accountStatusId = $accountRow["account_status_id"];
                            ?>
                            <tr>
                              ...
                              <td>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" 
                                data-bs-target="#residenceAccountDetails<?php echo $customerId.$accountStatusId; ?>" data-bs-whatever="@getbootstrap">
                                  <i class="fa-solid fa-eye" style="color: #fcfcfc;"></i>
                                </button>
                              </td>
                            </tr>
                            ...
                            <!-- Modal for displaying order details -->
                            <div class="modal fade" id="residenceAccountDetails<?php echo $customerId.$accountStatusId; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Order Details for <?php echo $customerName; ?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body row">
                                    <form method="post">
                                      ...
                                      $orderQuery = "SELECT tc.item_id, 
                                                            tc.prod_qnty as product_quantity, 
                                                            tc.status_id as item_status_id,
                                                            pt.prod_type_name as product_type, 
                                                            tf.fl_name as flavor_name, tf.fl_price as flavor_price, 
                                                            tf.fl_id as flavor_id,
                                                            tp.*,
                                                            CONCAT(td.first_name, ' ', td.middle_name, ' ', td.last_name) as customer_full_name, 
                                                            td.address as customer_address, 
                                                            td.contact as customer_contact, 
                                                            td.account_id as customer_account_id,
                                                            GROUP_CONCAT(ta.add_ons_name) AS add_ons_names,
                                                            GROUP_CONCAT(ta.add_ons_price) AS add_ons_prices,
                                                            ot.order_type_name as order_type, 
                                                            ot.order_type_id as order_type_id,
                                                            tr.status_name as item_status
                                                    FROM tbl_cart tc
                                                    INNER JOIN tbl_products tp ON tc.prod_id = tp.prod_id
                                                    INNER JOIN tbl_product_type pt ON tp.prod_type = pt.prod_type_id
                                                    LEFT JOIN tbl_adds_order ao ON tc.item_id = ao.item_id
                                                    ...
                                                    LEFT JOIN tbl_account_details td ON td.account_id = tc.account_id
                                                    LEFT JOIN tbl_status tr ON tc.status_id = tr.status_id
                                                    WHERE tc.status_id = 4 AND ot.order_type_id = 1 AND tc.account_id = ?
                                                    GROUP BY tc.item_id;";
                                      ...
                                      while ($orderRow = $orderResults->fetch_assoc()) {
                                        $orderTotal = ($orderRow["product_quantity"] * $orderRow["prod_price"]) + $orderRow["flavor_price"];
                                        $addOnsNamesArray = explode(',', $orderRow["add_ons_names"]);
                                        $addOnsPricesArray = explode(',', $orderRow["add_ons_prices"]);
                                        $addOnsDisplay = "None";
                                        if (!empty($orderRow["add_ons_names"])) {
                                          $addOnsDisplay = "";
                                          foreach ($addOnsNamesArray as $key => $addOn) {
                                            $addOnsDisplay .= $addOn . " - ₱" . number_format($addOnsPricesArray[$key], 2) . ", ";
                                            $orderTotal += $addOnsPricesArray[$key];
                                          }
                                          $addOnsDisplay = rtrim($addOnsDisplay, ", ");
                                        }
                                      ?>
                                      <div class="mb-3 col-md-6">
                                        <label class="col-form-label text-danger">Order ID</label>
                                        <input type="text" class="form-control" value="<?php echo $orderRow["item_id"]; ?>" disabled>
                                      </div>
                                      <div class="mb-3 col-md-6">
                                        <label class="col-form-label">Order Name</label>
                                        <input type="text" class="form-control" value="<?php echo $orderRow["prod_name"]; ?>" disabled>
                                      </div>
                                      <div class="mb-3 col-md-6">
                                        <label class="col-form-label">Order Flavor</label>
                                        <input type="text" class="form-control" value="<?php echo $orderRow["flavor_name"] . " ₱" . $orderRow["flavor_price"]; ?>" disabled>
                                      </div>
                                      <div class="mb-3 col-md-6">
                                        <label class="col-form-label">Order Add-Ons</label>
                                        <textarea class="form-control" disabled><?php echo htmlspecialchars($addOnsDisplay); ?></textarea>
                                      </div>
                                      <div class="mb-3 col-md-6">
                                        <label class="col-form-label">Order Price</label>
                                        <input type="text" class="form-control" value="₱<?php echo number_format($orderRow["prod_price"], 2); ?>" disabled>
                                      </div>
                                      <div class="mb-3 col-md-6">
                                        <label class="col-form-label">Order Quantity</label>
                                        <input type="text" class="form-control" value="<?php echo $orderRow["product_quantity"]; ?>" disabled>
                                      </div>
                                      <div class="mb-3">
                                        <label class="col-form-label">Total</label>
                                        <input type="text" class="form-control" value="₱<?php echo number_format($orderTotal, 2); ?>" disabled>
                                      </div>
                                      <div class="mb-3 row justify-content-end">
                                        <button type="button" class="btn btn-danger delete-js col-md-4" id="<?php echo $orderRow["item_id"] ?>">
                                          Cancel Order
                                        </button>
                                      </div>
                                      <?php } ?>
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-success updateBtn" data-status-id="<?php echo $accountStatusId ?>">
                                      <i class="fa-solid fa-check" style="color: #fcfcfc;"></i>
                                    </button>
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                  </div>
