...
<body>
    ...
    <!-- ALL PRODUCTS -->
    <h1 class="product_title">ALL PRODUCTS</h1>
                                  ...
                                  <div class="row">
                                      <div class="el-wrapper">
                                          ...
                                          <div class="box-down">
                                              ...
                                              <a class="cart" href="./productpage/product.php?product_id=<?php echo $prod_id; ?>">
    ...
    <footer class="footer">
        <div class="container1">
            <div class="row1">
                <div class="logo2">
                    <a href="index.php"><img  src="picture/icon/logo1.png" alt=""></a>
                </div>
    ...
    <script>
        ...
        document.getElementById('searchFormDesktop').addEventListener('submit', function (e) {
            ...
            fetch(`fetchProducts.php?search=${encodeURIComponent(searchQuery)}`)
                .then(response => response.text())
                .then(data => {
                    // Update the product container with the results
                    document.querySelector('.row1').innerHTML = data;
                })
